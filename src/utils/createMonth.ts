import {createDate, CreateParams} from "./createDate";
import {getMonthNumberOfDays} from "./getMonthNumberOfDays";

export const createMonth = (params?: CreateParams) => {
    ...
    return{
        getDay,monthIndex,monthNumber,monthName,year,createMonthDays
    }
}